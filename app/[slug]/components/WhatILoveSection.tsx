...
interface WhatILoveSectionProps {
    text?: string
...
export default function WhatILoveSection({
    ...
    proposerName,
    onComplete
}: WhatILoveSectionProps) {
    const scrollContainerRef = useRef<HTMLDivElement>(null)
    const contentRef = useRef<HTMLDivElement>(null)

    // Default text if none provided
    const storyText = text || `${partnerName}, there are so many reasons why I love you.

I love the way you laugh, the way you light up every room you enter.

I love your kindness, your strength, and the way you make me feel like the luckiest person alive.

Every moment with you is a gift I treasure.`

    // Auto-scroll effect (same as HowWeMetSection)
    useEffect(() => {
    ...
    return (
        <section className="fixed inset-0 bg-black flex items-center justify-center overflow-hidden">
            ...
            >
                <span className="text-rose-400 text-sm font-sans tracking-[0.3em] uppercase">
