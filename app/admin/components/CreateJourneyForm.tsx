...
import { Upload, Link as LinkIcon, Save, Loader2, X, AlertCircle } from 'lucide-react'
import { z } from 'zod'
...
export default function CreateJourneyForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSuccessLink(`${window.location.origin}/${data.journey.slug}`)
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className={`w-full bg-neutral-900 border rounded-lg px-4 py-2 focus:ring-2 focus:outline-none ${validationErrors.slug
                                ? 'border-red-500 focus:ring-red-500'
                                : 'border-neutral-800 focus:ring-rose-500'
                                }`}
                        />
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full bg-neutral-900 border rounded-lg px-4 py-2 focus:ring-2 focus:outline-none ${validationErrors.passcode
                                ? 'border-red-500 focus:ring-red-500'
                                : 'border-neutral-800 focus:ring-rose-500'
                                }`}
                        />
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full bg-neutral-900 border rounded-lg px-4 py-2 focus:ring-2 focus:outline-none ${validationErrors.partner_name
                                ? 'border-red-500 focus:ring-red-500'
                                : 'border-neutral-800 focus:ring-rose-500'
                                }`}
                        />
                        {validationErrors.partner_name && (
                            <p className="text-red-400 text-xs flex items-center gap-1">
                                <AlertCircle className="w-3 h-3" />
                                {validationErrors.partner_name}
                            </p>
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full bg-neutral-900 border rounded-lg px-4 py-2 focus:ring-2 focus:outline-none ${validationErrors.proposer_name
                                ? 'border-red-500 focus:ring-red-500'
                                : 'border-neutral-800 focus:ring-rose-500'
                                }`}
                        />
                        {validationErrors.proposer_name && (
                            <p className="text-red-400 text-xs flex items-center gap-1">
                                <AlertCircle className="w-3 h-3" />
                                {validationErrors.proposer_name}
                            </p>
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`w-full bg-neutral-900 border rounded-lg px-4 py-2 focus:ring-2 focus:outline-none ${validationErrors.proposer_phone
                                ? 'border-red-500 focus:ring-red-500'
                                : 'border-neutral-800 focus:ring-rose-500'
                                }`}
                        />
                        {validationErrors.proposer_phone && (
                            <p className="text-red-400 text-xs flex items-center gap-1">
                                <AlertCircle className="w-3 h-3" />
                                {validationErrors.proposer_phone}
                            </p>
                ...
                <div className="space-y-2">
                    ...
                    <select
                        ...
                        className={`w-full bg-neutral-900 border rounded-lg px-4 py-2 focus:ring-2 focus:outline-none ${validationErrors.music_url
                            ? 'border-red-500 focus:ring-red-500'
                            : 'border-neutral-800 focus:ring-rose-500'
                            }`}
                    >
                    ...
                    {musicFiles.length === 0 && (
                        <p className="text-xs text-neutral-500">
                            No music uploaded yet. Go to the Music Library tab to upload songs.
                        </p>
                    )}
                    {validationErrors.music_url && (
                        <p className="text-red-400 text-xs flex items-center gap-1">
                            <AlertCircle className="w-3 h-3" />
                            {validationErrors.music_url}
                        </p>
